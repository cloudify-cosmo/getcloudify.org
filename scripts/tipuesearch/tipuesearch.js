          ...
          return this.each(function() {
               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         {
                              out += '<div style="visibility:hidden"  id="tipue_search_warning_head">Nothing found</div>'; 
					...
					if(out.indexOf("Nothing found") > -1){
						//goGoogle = 1;
						googleSearch();
						//$('#resultsDiv').show();						
					}else{
...
//START GOOGLE SEARCH FUNCTION TO TIPUE SEARCH
//////////////////////////////////////////////////////
    ...
    function googleSearch(settings) {
		...
		settings.term = $('#tipue_search_input').val().toLowerCase();
...
//END GOOGLE SEARCH FUNCTION TO TIPUE SEARCH
/////////////////////////////////////////////////////////////
