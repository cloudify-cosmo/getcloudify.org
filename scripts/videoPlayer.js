		...
		if(options.addThumbs) {
			...
			selector.children().each(function(i){
				...
				if(options.thumbSize == 'small') {
					var thumbUrl = "http://img.youtube.com/vi/"+youtubeid($(this).children().children("a").attr("href"))+"/2.jpg";
				}
				else {
					var thumbUrl = "http://img.youtube.com/vi/"+youtubeid($(this).children().children("a").attr("href"))+"/0.jpg";
				}
