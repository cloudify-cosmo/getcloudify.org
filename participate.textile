                     ...
                     <div class="eventBox">
                           <div class="eventInfoLeft">
								...
								<a href="http://twitter.com/home?status=Event: Does PaaS pass the bar? April, 16, 2012, Veenendaal, the Netherlands To Register Visit: http://www.cloudifysource.org/participate via @cloudifysource" class="">
									<img class="event-twitt" src="images/event-twitter.png" />
								</a>
								<a href="https://twitter.com/share" class="twitter-share-button" data-via="cloudifysource">
									<img class="event-fb" src="images/event-fb.png" />
									</a>                                                               
                            </div>
...
<!-- Webinar Start -->
                      <div class="eventBox">
                           <div class="eventInfoLeft">
								...
								<a href="http://twitter.com/home?status=Webinar: The Easy Way to Manage your Sharded MongoDB Setup on Any Cloud, 4-24-12 To Register Visit: http://www.cloudifysource.org/participate via @cloudifysource" class="">
									<img class="event-twitt" src="images/event-twitter.png" />
								</a>
								<a href="https://twitter.com/share" class="twitter-share-button" data-via="cloudifysource">
									<img class="event-fb" src="images/event-fb.png" />
...
<!-- Webinar Start -->
                      <div class="eventBox">
                           <div class="eventInfoLeft">
								...
								<a href="http://twitter.com/home?status=Webinar: Big Data in the Cloud, May 8, 2012 To Register Visit: http://www.cloudifysource.org/participate via @cloudifysource" class="">
									<img class="event-twitt" src="images/event-twitter.png" />
									</a>
									<a href="https://twitter.com/share" class="twitter-share-button" data-via="cloudifysource">
										<img class="event-fb" src="images/event-fb.png" />
...
<!-- Webinar Start -->
                      <div class="eventBox">
                           <div class="eventInfoLeft">
								...
								<a href="http://twitter.com/home?status=Webinar: Extending Chef to manage the Entire Application Lifecycle, May 8, 2012 To Register Visit: http://www.cloudifysource.org/participate via @cloudifysource" class="">
									<img class="event-twitt" src="images/event-twitter.png" />
								</a>
								<a href="https://twitter.com/share" class="twitter-share-button" data-via="cloudifysource">
									<img class="event-fb" src="images/event-fb.png" />
