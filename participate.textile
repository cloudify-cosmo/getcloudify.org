...
<!-- Webinar Start -->
                      <div class="eventBox">
                           <div class="eventInfoLeft">
								...
								<a href="http://twitter.com/home?status=Webinar: Extending Chef to manage the Entire Application Lifecycle, May 8, 2012 To Register Visit: http://www.cloudifysource.org/participate via @cloudifysource"><img class="event-twitt" src="images/event-twitter.png" /></a><a href="https://www.facebook.com/share.php?u=http://bit.ly/GFx0WM" class="twitter-share-button" data-via="cloudifysource"><img class="event-fb" src="images/event-fb.png" /></a>
                                <div class="clear"></div>
                            </div>
