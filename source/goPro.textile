...
<button type="button" data-toggle="collapse" data-target="#collapsibletable" class="btn btn-medium btn-inverse btn-toggle"><i class="icon-plus"></i> Compare Cloudify Editions</button></div>
