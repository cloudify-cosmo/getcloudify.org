...
<button type="button" data-toggle="collapse" data-target="#collapsiblefull" class="btn btn-medium btn-inverse btn-toggle"><i class="icon-plus"></i> Compare Cloudify Editions</button></div>
...
<br/>
   ...
   <hr/>
             <section id="content">
                    ...
                    <div class="row">
                                <div class="span12">
                                    <h3>How to Get  <strong>Community Support</strong></h3></div>
