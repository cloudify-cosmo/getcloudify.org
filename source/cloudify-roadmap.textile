...
<div class="bs-callout bs-callout-warning"><strong>Note</strong><br>
    Cloudify aims for a minor release every 4-6 months with new features, bug fixes, security enhancements, and more. A service release with bug and security fixes is also intended for delivery every 1-2 months. The next release is Cloudify 4.0, expected in Q1 2017. Items that are marked as <strong>In Progress - 4.0</strong> below are included in this release. 
</div>
...
<li><strong>Multi-tenancy</strong>: The ability to set tenants with a Cloudify Manager and isolate resources among them, such that one tenant does not have visibility of, nor the ability to access, data/resources of another. Also, the ability to set a resource as public to the whole tenant or private (only admins and owner(s) can access it). <strong>IN-PROGRESS - 4.0</strong></li>
...
<li><strong>Encrypted Data Store</strong>: Encrypted key/value store for storing application-sensitive data such as cloud credentials, secrets and configuration parameters, which users can then access via blueprints. <strong>IN-PROGRESS - 4.0</strong></li>
...
<li><strong>Tenants Support</strong>: So you can upload a blueprint to a 4.0 Cloudify Manager and enjoy all of this version’s benefits. <strong>IN-PROGRESS - COMPOSER 2.4</strong></li>
<li><strong>Imports and Examples Catalog</strong>: Improved experience for importing external blueprints, plugins and stencils (node types) to the Composer, and also allowing you to configure the imports you want to have OOTB with any new blueprint, and to upload your most commonly used blueprints to the catalog. </li>
<li><strong>Source Tab Editing Ability</strong>: Allows you to make changes in the code and they will be reflected in the topology.</li>
<li><strong>Upload Blueprint to Github</strong>: So you can manage them directly from there. </li>
<li><strong>Improved Ease-of-Use</strong>: With much-desired functionalities like Undo, Node clone, Multiple selection of nodes and more.</li>
</ul>
