...
*  "Debugger":../developing/debugger.html - Cloudify now enables users to debug Shell and Groovy scripts during runtime.html
*  "Recipe Repository":../setup/recipes_tab.html - Cloudify enables users to install recipes from the Web UI.html
*  "Storage API":../developing/storage.html - Users can now create, attach, detach or re-attach to a device from a recipe.html
<hr/>
...
This version contains the following key improvements:
*  "Configurable ports and memory":../clouddrivers/cloud_driver.html#cd - Cloudify now enables users to configure ports and memory usage.html
*  "Cloud driver structure change":../clouddrivers/cloud_driver.html#cd - Cloudify cloud driver file now has a new structure.html
...
This version contains the following key improvements:
*  "Multi Tenant Deployment":../developing/service_recipe.html#mtd - Cloudify now enables users to deploy several services on the management machines as well, via multitenancy.html
