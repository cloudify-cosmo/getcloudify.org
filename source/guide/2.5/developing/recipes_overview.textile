...
** "UI layout":../developing/configuring_ui_section:.html Describes the layout to use for displaying the collected metrics in the "Cloudify web management console":..html/monitoring/the_web_management_console.html
