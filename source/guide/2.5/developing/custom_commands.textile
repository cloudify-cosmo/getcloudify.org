...
In many scenarios, you may want to have greater control over your application service than is provided by the built-in "lifecycle events":../developing/lifecycle_events..html For example, you may want to implement various application-level concerns, such as hot upgrades (e.g. replacing a @.war@ file, and then refreshing the web container), database schema updates, and more.html
