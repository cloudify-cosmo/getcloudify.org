...
<br/>
<h4 class="impt">For setting the cloud driver, we reccomend that you use "parameterization of the cloud driver configuration":../clouddrivers/cloud_driver.html#gstr, but you can also set the cloud driver directly as shown in the following example (of a @rsopenstack-cloud.htmlgroovy@ file):</h4>
