...
This topic describes the post-installation tasks that you should complete after "installing the Cloudify shell":../setup/installing_the_cloudify_client..html The post-installation tasks will prepare you for bootstrapping clouds and deploying applications.html
...
h4(impt). The ports can be configured as described "here":../clouddrivers/cloud_driver.html#cd.html
