...
Before you bootstrap your cloud, make sure that your environment meets all the minimum requirements. For more information, see "Bootstrapping Prerequisites":../bootstrapping/bootstrapping_process.html#prereqs.html
...
* "HP OpenStack Cloud":../setup/configuring_openstack.html (openstack)
