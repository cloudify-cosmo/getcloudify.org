...
For information about undeploying on Azure, see the *Undeploying* section in "Deploying on Azure":http://getcloudify.org/guide/2.7/undeploying/undeploy_azure.html