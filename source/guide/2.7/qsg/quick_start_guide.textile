...
For more information, see <span class="inlineExpandBtn" title="../setup/installing_the_cloudify_client.html">Installing the Cloudify Shell</span>.
...
For more information about bootstrapping on a local cloud, see <span class="inlineExpandBtn" title="../bootstrapping/bootstrapping_localcloud.html">Boostrap a Local Cloud</span>.
...
For more information, see <span class="inlineExpandBtn" title="../developing/scaling_rules.html">Scaling Rules</span>.
...
<h4 class="impt">To see it in action, watch the demonstration <a href="https://www.youtube.com/watch?v=V3NNreNRxMQ" target="_blank" rel="bUmt6NX7M9I" class="youtube wtd" data-bitly-type="bitly_hover_card">video</a>.</h4>
