...
The policies are written in [Clojure](http://clojure.org/). Riemann offers many [built ind functions for analyzing monitoring information](http://riemann.io/api.html).
