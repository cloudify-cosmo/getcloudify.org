...
<section id="content">
	...
	<div class="row">
					...
					<div class="span12">
						...
						<div class="span12">
							<p><strong>For more details on how to get started with them please follow the Cloudify 3.2 <a href="{{ site.baseurl }}/guide/3.2/quickstart.html" target="_blank"><i class="icon-book"></i> Getting Started Guide</strong></a>.</p>
						</div>
		</div>
					<hr/>
