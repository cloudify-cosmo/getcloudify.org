...
<h2 class="name"><strong>Installing Cloudify Manager After CLI Package Install</strong></h2>
...
<p><strong>Step 1:</strong> Ensure that you have properly installed <a href="http://docs.getcloudify.org/3.3.1/installation/from-packages/">Cloudify CLI</a>.</p>
...
...
 ...
 <div class="bs-callout bs-callout-warning"><strong>
    Make sure you use a &lt;tag&gt; from <a href="https://github.com/cloudify-cosmo/cloudify-manager-blueprints/releases">cloudify-manager-blueprints</a> that matches your Cloudify version. Blueprints taken from the master branch might not work for you.
</div>
