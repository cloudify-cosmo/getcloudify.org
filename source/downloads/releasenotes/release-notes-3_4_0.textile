...
<ul>
<li><a href="http://docs.getcloudify.org/3.4.0/cli/upgrade/"><strong>In-Place Manager Upgrade</strong></a> - A new Cloudify Manager upgrade process was introduced, which allows in-place upgrades for Cloudify Manager components and offers easier maintenance of the manager.</li>
