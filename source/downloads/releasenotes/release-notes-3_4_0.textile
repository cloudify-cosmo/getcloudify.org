...
<ul>
		...
		<li><a href="https://cloudifysource.atlassian.net/browse/CFY-4959">CFY-4959</a> Host Pool Plugin/Service Major Rewrite</li>
				<span style="margin-left:5em">Rewrote API server</span></li><br>
				<span style="margin-left:5em">Added service logging</span></li><br>
				<span style="margin-left:5em">Changed backend to TinyDB</span></li><br>
				<span style="margin-left:5em">Added mixed-OS pool support</span></li><br>
				<span style="margin-left:5em">Removed requirement for config YAML file</span></li><br>
				<span style="margin-left:5em">Added non-daemon service option</span></li><br>
				<span style="margin-left:5em">Added flask-restful exception handling</span></li>
