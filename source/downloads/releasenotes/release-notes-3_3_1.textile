	...
	<div class="container">
		<div class="row">
			<div class="span12">
				...
				<br/>
				<h1><i class="icon-download"></i>&nbsp;&nbsp;<strong>Release Notes 3.3.1</strong></h1>	
			</div>
		</div>			
	</div>
</section>
				...
				<div class="row">
					<div class="span12">
						...
						<div width="100%" text-align="center" class="aligncenter">
                                ...
                                <div style="overflow: hidden; display: inline-block;" class="btn btn-info btn-sm"><a href="https://cloudifysource.atlassian.net/issues/?filter=18682">New Features & Improvements</a>
                				</div>
                                <div style="margin-left:20px; overflow: hidden; display: inline-block;" class="btn btn-info btn-sm"><a href="https://cloudifysource.atlassian.net/issues/?filter=18680">Fixed Issues</a>
                				</div>
                				<div style="margin-left:20px; overflow: hidden; display: inline-block;" class="btn btn-info btn-sm"><a href="https://cloudifysource.atlassian.net/issues/?filter=18683">Known Issues</a>
                				</div>
                				<div style="margin-left:20px; overflow: hidden; display: inline-block;" class="btn btn-info btn-sm"><a href="http://getcloudify.org/downloads/releasenotes/3.3.1_Release_Notes.pdf" download>Download Release Notes</a>
                				</div>	
								 </p> 
                        </div>
