	...
	<div class="container">
		<div class="row">
			<div class="span12">
				...
				<br/>
				<h1><i class="icon icon-book"></i>&nbsp;&nbsp;<strong>Release Notes 3.3.1</strong></h1>	
			</div>
		</div>			
	</div>
</section>
				...
				<div class="row">
					<div class="span12">
						...
						<div width="100%" text-align="center" class="aligncenter">
                                ...
                                <div style="overflow: hidden; display: inline-block;" class="btn btn-info btn-sm"><a href="https://cloudifysource.atlassian.net/issues/?filter=18682"><font color="white">New Features & Improvements</font></a>
                				</div>
                                <div style="margin-left:20px; overflow: hidden; display: inline-block;" class="btn btn-info btn-sm"><a href="https://cloudifysource.atlassian.net/issues/?filter=18680"><font color="white">Fixed Issues</font></a>
                				</div>
                				<div style="margin-left:20px; overflow: hidden; display: inline-block;" class="btn btn-info btn-sm"><a href="https://cloudifysource.atlassian.net/issues/?filter=18683"><font color="white">Known Issues</font></a>
                				</div>
                				<div style="margin-left:20px; overflow: hidden; display: inline-block;" class="btn btn-theme btn-sm"><a href="http://getcloudify.org/downloads/releasenotes/3.3.1_Release_Notes.pdf" download><font color="white">Download Release Notes</font></a>
                				</div>	
								 </p> 
                        </div>
...
<p>All "CFY" links below can be used to find the associated JIRA case.</p>
  <ul>
    <li>
      <h3>Features</h3>
    ...
    <li>
      ...
      <ul>
        <li>
          <p><a href="https://cloudifysource.atlassian.net/browse/CFY-4608">CFY-4608 - Imports previously timed out and thrown exceptions, a retry mechanism is now implemented for connectionerror and timeout errors and any response with code &gt;= 500.</a></p>
        </li>
