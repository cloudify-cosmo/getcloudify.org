...
<tr>
<td style="width: 500px;">
					Deployment Modeling with TOSCA&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-white btn-toggle"><font color="#00B4DA"><i class="icon-plus"></i></font></button>
