...
<tr>
<td style="width: 500px;">
					Deployment Modeling with TOSCA&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-toggle" align="right"><i class="icon-plus"></i></button>
