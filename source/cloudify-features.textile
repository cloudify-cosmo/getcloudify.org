...
h1. *Full Feature List*

<section id="content">
<div class="row">
<div class="span12">
<div class="aligncenter">
<table border="1" cellpadding="8" cellspacing="1" style="width: 800px;">
<tbody>
<tr>
...
<tr>
<td style="width: 500px;">
					Deployment Modeling with TOSCA&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
                                   <p><strong>Rich modeling language implementing TOSCA simplified YAML profile</strong></p>		
                                  </div></td>

<td style="width: 100px;"><h3><strong><font color="#66b11c"><i class="icon-ok"></i></font></strong></h3>
					</td>
<td style="width: 100px;"><h3><strong><font color="#66b11c"><i class="icon-ok"></i></font></strong></h3>
					</td>
<td style="width: 100px;"><h3><strong>
					Released</strong></h3></td>
</tr>
<tr>
<td style="width: 500px;">
					Extensible Python-based Workflow Engine&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Metric and Log Collection&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Extensible Policy Engine&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					REST API&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Rich CLI&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Web UI (including monitoring)&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<td class="rtecenter" style="width: 77px;">
					&nbsp;</td>
<td class="rtecenter" style="width: 72px;">
					<img alt="" src="http://d3a0pn6rx5g9yg.cloudfront.net/sites/default/files/Cloudify-green-check.png" style="width: 24px; height: 24px;" /></td>
...
<tr>
<td style="width: 500px;">
					Security - AuthZ&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Manager Recovery (on OpenStack)&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Manager Recovery Watchdog&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Visual Blueprint Composer&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Multi-Tenancy&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<td style="width: 500px;">
					Manager Distributed Blueprint&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Manager HA&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Blueprint Catalog&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Governance Policies&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					AWS VPC Plugin&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-small btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
