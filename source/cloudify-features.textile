...
<div class="span12">
<p>&nbsp;</p>
<h1>Cloudify comes in two editions - open source and free for life, and the Premium edition.  Learn more about each below.</h1>
<div class="aligncenter">
<p>&nbsp;</p>
<h2><strong>Full Feature List </strong></h2></div>
<p>&nbsp;</p>

<div class="aligncenter">
<table border="1" cellpadding="8" cellspacing="1" style="width: 800px; align: center;">
<tbody>
<tr>
...
<tr>
<td style="width: 500px;">
					Deployment Modeling with TOSCA&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><font color="#00B4DA"><i class="icon-plus"></i></font></button>
...
<tr>
<td style="width: 500px;">
					Extensible Python-based Workflow Engine&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Metric and Log Collection&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Extensible Policy Engine&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					REST API&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Rich CLI&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Web UI (including monitoring)&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Security - AuthZ&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Manager Recovery (on OpenStack)&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Manager Recovery Watchdog&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Visual Blueprint Composer&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Multi-Tenancy&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<td style="width: 500px;">
					Manager Distributed Blueprint&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Manager HA&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Blueprint Catalog&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					Governance Policies&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
...
<tr>
<td style="width: 500px;">
					AWS VPC Plugin&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-rounded btn-toggle"><i class="icon-plus"></i></button>
					<div class="collapse" id="collapsible"> 
