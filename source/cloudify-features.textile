...
<tr>
<td style="width: 500px;">
					Extensible Python-based Workflow Engine&nbsp;<button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-mini btn-theme btn-toggle" style="float: right;"><i class="icon-plus"></i></button>
