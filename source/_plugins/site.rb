module Jekyll
  ...
  class Site
    ...
    def site_payload
        ...
        payload["categories_3_2"]=["Getting Started", "Agents", "Guides", "Product Architecture and Flows", "Reference", "Official Plugins", "Contributed Plugins", "DSL Specification", "User Interface", "Troubleshooting"]
