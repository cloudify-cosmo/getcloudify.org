...
In 2.2 we "announced":/2012/12/05/cloudify_2_2_and_roadmap.html our "Chef integration":/guide/2.7/integrations/chef_documentation.html, "REST API":/guide/2.7/restapi/restdoclet.html, and a number of important usability improvements that allow for more robust applications on top of Cloudify.

With version 2.3, which we announced today, we have a few more surprises up our sleeve, and some are quite significant.

* "Security and multi-tenancy":/guide/2.7/setup/configuring_security Cloudify 2.3 introduces a comprehensive security model for securing the access to the Cloudify controller, including pluggable authentication, authorization and transport security. 
...
* Troubleshooting: Cloudify 2.3 takes another step in making it easier for users to develop recipes. When developing new recipes, "Cloudify now allows you":/guide/2.7/recipe/command_line_reference.html#install_app to 'freeze' the situation in case of recipe execution failure, and let you log in to the VMs to troubleshoot the failure.
...
As always, we welcome your "feedback":https://cloudifysource.zendesk.com/forums, "(newwindow)bug reports":https://cloudifysource.atlassian.net/secure/Dashboard.jspa and "contributions":/guide/2.7/contribute/how_to.html.
