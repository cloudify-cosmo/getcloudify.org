...
<p><a href="/images/cloudlamp.jpg"><img style="margin: 0px 12px 0px 0px; display: inline; float: left" title="CloudifyLightbulb" alt="CloudifyLightbulb" align="left" src="/images/cloudlamp.jpg" width="240" height="240" /></a>In my previous post <a href="http://getcloudify.org/2012/10/30/moving_enterprise_workloads_to_the_cloud_on_a_massive_scale.html">Moving Enterprise Workloads to the Cloud on a Massive Scale</a>, I pointed out the reasons for moving Enterprise workloads to the cloud.</p>
