...
You can try out the OpenStack version that we launched in collaboration with HP at "getcloudify.org":http://getcloudify.org.

For more information about the Cloudify Player and how it works, please see Uri Cohen's blog post "Introducing the Cloudify Player":http:/getcloudify.org/2013/05/15/introducing_the_cloudify_player.html.