...
<span class="pullquote-left">
  <h2><font style="font-weight: bold" size="5" face="Baskerville Old Face"><em>White Paper: NFV and What it Means to You. Get it today. </em></font>&nbsp; &nbsp; <a class="btn btn-large btn-theme btn-rounded download" id="downloadBtnInner" href="http://getcloudify.org/brochures/NFV White Paper April 2015.pdf" target="_blank"><i class="icon-plus"></i> Go </a></h2></span>
