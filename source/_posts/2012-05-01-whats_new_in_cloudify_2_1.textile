...
You can already see the prototype of this effort on "(newwindow)Github":https://github.com/CloudifySource/cloudify-recipes/tree/master/services/chef (where you can find the rest of the Cloudify sources too). Fear not though, a more complete integration with many cookbooks is in the works.
