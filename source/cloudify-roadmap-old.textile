...
<div class="bs-callout bs-callout-warning"><strong>Note</strong><br>
  ...
  <ul>
    <li>
      <p>Cloudify Manager upgrade process improvements, spcifically the ability to easily upgrade the manager in-place without bringing it down <strong>&#42;Done&#42;</strong></p>
    </li>
    ...
    <li>
      <p>Improved Manager bootstrap process: support for a single tar for all manager components (instead of multiple RPMs), QCOW2 and OVA manager images, embdding the Python runtime in both manager and CLI <strong>&#42;Done&#42;</strong></p>
    </li>
  ...
  <ul>
    <li>
      <p>Securing all internal communication via SSL <strong>&#42;Done&#42;</strong></p>
    </li>
  ...
  <ul>
    <li>
      <p>Live topology update: The ability to update the topology of a running deployment, e.g. add / remove nodes, change properties, update referenced workflow and life cycle scripts <strong>&#42;Done&#42;</strong></p>
    </li>

    <li>
      <p>Blueprint composition: Ability to model application components in separate yaml files and stitch them all together into a single blueprint using the import funtionality <strong>&#42;Done&#42;</strong></p>
    </li>
    ...
    <li>
      <p>Resource grouping: Ability to group together a set of nodes in a blueprint (e.g. a VM, two volumes and a floating IP) to allow users to scale them together as a one aggregate resource <strong>&#42;Done&#42;</strong></p>
    </li>

    <li>
      <p>Allow to specify number of instances via a blueprint input <strong>&#42;Done&#42;</strong></p>
    </li>
  ...
  <ul>
    <li>
      <p>Simplify the CLI installation process by embedding the Python runtime in the CLI package <strong>&#42;Done&#42;</strong></p>
    </li>
  ...
  <ul>
    <li>
      <p>Plugins CRUD Management in user interface <strong>&#42;Done&#42;</strong></p>
    </li>

    <li>
      <p>Snapshots management in user interface <strong>&#42;Done&#42;</strong></p>
    </li>

    <li>
      <p>Enable and disable maintenance mode from the UI <strong>&#42;Done&#42;</strong></p>
    </li>

    <li>
      <p>Support for embedding the UI in other web pages via a dedicated embed mode the strips out the header and the footer for the page <strong>&#42;Done&#42;</strong></p>
    </li>
    ...
    <ul>
        <li>
            <p>Blueprint import: the ability to import a full blown existing blueprint archive, including all releated resources (scripts, artifacts, binaries, etc.) into the composer and update it in it <strong>&#42;Done&#42;</strong></p>
        </li>
        <li>
            <p>Full CRUD support for custom type and relathionship definitions: The ability to introduce, use, update and delete custom user defined TOSCA type and relationships definitions <strong>&#42;Done&#42;</strong></p>
        </li>
	<li>
  ...
  <ul>
    <li>
        <p>Google Cloud Platform plugin <strong>&#42;Done&#42;</strong></p>
    </li>
    <li>
      <p>Microsoft Azure Plugin <strong>&#42;Done&#42;</strong></p>
    </li>

    <li>
      <p>Kubernetes Plugin <strong>&#42;Done&#42;</strong></p>
    </li>
