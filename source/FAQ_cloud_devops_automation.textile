 ...
 *A:*  For running the Cloudify CLI, you need to have Python 2.7. When running on clouds such as OpenStack or Amazon, you need to have proper IaaS credentials and set them properly in Cloudify. For more details, please see our "guide":http://getcloudify.org/guide/installation-cli.html.
