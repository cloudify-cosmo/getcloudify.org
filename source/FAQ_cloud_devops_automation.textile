 ...
 *A:* Download it "here":http://getcloudify.org/downloads/get_cloudify.html, and then head over to the "Getting Started":http://docs.getcloudify.org/3.3.0/intro/getting-started/ guide, and follow the instructions. 
 ...
 *A:* Yup, see above. Cloudify enables you to leverage any Chef cookbook or Puppet manifest.  So working with either tool is really intuitive with Cloudify.  We have a whole area dedicated to using "Chef":http://docs.getcloudify.org/3.3.0/plugins/chef/ with Cloudify, and you can check out how to get started with the "Puppet plugin":http://docs.getcloudify.org/3.3.0/plugins/puppet/ here. So be sure to check it out if you're using one of these tools.*
 ...
 *A:* Cloudify supports pretty much "any cloud":http://getcloudify.org/cloud_orchestration_cloud_automation.html#HPLink.  No wait it’s true - hear us out.  There are clouds that are supported out of the box with already available "plugins":http://docs.getcloudify.org/3.3.0/plugins/overview/ - the most common clouds OpenStack, vCloud, Azure CloudStack, Softlayer, AWS and a bunch of others, you can check out our documentation for the full list.
...
To get started just follow our "quick start guide":http://docs.getcloudify.org/3.3.0/blueprints/overview/.
...
If there is a blueprint you need that doesn’t exist "in our repo":https://github.com/cloudify-cosmo, you can copy the syntax from the existing blueprints and create your own.  Our blueprints are written in YAML so they’re pretty straightforward.  To learn how to get started check out "these resources":http://docs.getcloudify.org/3.3.0/blueprints/overview/, you can also purchase "pro support":#q17 which offers custom blueprint support.*
 ...
 *A:* Yup.  Cloudify supports "Vagrant based installation":http://getcloudify.org/downloads/get_cloudify.html, which means for testing purposes or any other reason you may have, you can bootstrap Cloudify on your local environment and get started. Read how "here.":http://docs.getcloudify.org/3.3.0/intro/getting-started/
