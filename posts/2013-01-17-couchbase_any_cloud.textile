...
---
  ...
  See this sample recipe for an app that consists of Couchbase, Tomcat and Apache HTTP server: <br/>
<br/>
 ...
 <br/>
  ...
  <p>We've created a special Cloudify player that lets you test drive you Couchbase recipe on demand, without having to download or install Cloudify at all. By just clicking on the Play button below, and then waiting a couple of seconds, you will have a running Couchbase instance on the cloud, for you to fiddle around with for a whole hour. You can then look at the Couchbase console or the Cloudify console, and even write test code to interact with this server.</p>
  ...
  <script type="text/javascript" id="cloudify-widget" data-api-key="2850beaa-9414-460c-b1e1-1e15b429c53a" data-title="Launch CouchBase 2.0" data-host="launch.cloudifysource.org" data-video_url="http://www.youtube.com/v/N8V44NoVhKM" src="http://launch.cloudifysource.org/js/get_widget.js"></script>
