...
I am still amazed from time to time to find that even very intelligent people who know a lot about software development, but nothing about cloud computing, don't seem to know this truth about cloud "world" : when a machine (VM) goes down, its data is gone forever, unless you take precautions in advance.
...
Storing your data on a cloud, is much cheaper than in your offices, but regadrless of the price, it will lead to a disaster if you don't define and implement automated backup and storage procedures.

Cloudify comes with "Storage API support":http://www.cloudifysource.org/guide/2.5/developing/storage which is currently only available for the EC2 EBS and for "Openstack IaaS" storage.
