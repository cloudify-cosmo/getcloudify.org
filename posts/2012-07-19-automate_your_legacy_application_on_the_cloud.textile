---
layout: blogpost
title: Automate Your Legacy Application on the Cloud
image: tamir.jpg
author: Tamir Korem
tags: 
 - Cloudify
...
"(newwindow)Cloudify Custom Commands":http://www.cloudifysource.org/guide/developing/custom_commands enable admin users or third-party tools to remotely manage service instances, which is especially useful when remote service APIs aren't available.
...
For example, these commands are invoked during the @postStart@ and @postStop@ "(newwindow)lifecycle event handlers":http://www.cloudifysource.org/guide/developing/lifecycle_events
...
The following presentation illustrates the various steps from the installation of the services to modifying the @apacheLB@ configuration by invoking custom commands:

<div style="width:684px" id="__ss_13575384"> <strong style="display:block;margin:12px 0 4px"><a href="http://www.slideshare.net/tamirko/custom-commands211" title="Cloudify&#39;s Custom Commands Are Here To Stay" target="_blank">Cloudify&#39;s Custom Commands Are Here To Stay</a></strong> <iframe src="http://www.slideshare.net/slideshow/embed_code/13575384?rel=0" width="684" height="557" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC;border-width:1px 1px 0" allowfullscreen></iframe> <div style="padding:5px 0 12px"> View more PowerPoint from <a href="http://www.slideshare.net/tamirko" target="_blank">tamirko</a> </div> </div>
...
Here's the 2"load"@ code snippet in apacheLB-service.groovy : 
