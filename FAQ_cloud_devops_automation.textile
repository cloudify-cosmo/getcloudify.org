 ...
 *A:* Can we be cheese? We value each and every Cloudify user and community member, so if you have any ideas or "feature requests":https://cloudifysource.atlassian.net/browse/CFY, we love to keep innovating, so definitely reach out and let us know what you’re thinking.
 ...
 And we know, there’s no open source tool without an awesome community to back it, so we hope the site provides you with all the resources you need - "docs":/guide.html, "blog":/blog.html, "video tutorials"/cloudifysourcetv.html and more.  You can also find help in our "developer":https://groups.google.com/forum/#!forum/cloudify-developers and "user":https://groups.google.com/forum/#!forum/cloudify-users forums.  Be sure to join us and don’t be shy to reach out.
