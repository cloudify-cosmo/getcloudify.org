...
<h1><i class="icon-question-sign"></i> Cloudify<strong> FAQ</strong></h1>
...
h2. *Q: How do I install Cloudify?*
...
h2. *Q: Which clouds do you support?*
...
h2. *Q: Can I remove a service after I deploy an application?*
...
h2. *Q: Can I add a service after I deploy an application?*
...
h2. *Q: I deployed a Tomcat service and now I have a new WAR file.*
...
h2. *Q: Where can I get updated about new releases?*
...
h2. *Q: What is Cloudify's pricing?*
...
h2. *Q: What application stacks can I use?*
...
h2. *Q: How can I contribute to the Cloudify open source project?*
...
h2. *Q: What does the test-recipe command do?*
...
h2. *Q: Where will the serviceDirectory point to?*
...
h2. *Q: What should I have on my environment prior to using Cloudify?*
...
h2. *Q: Where can I suggest a feature or report a bug?*
...
h2. *Q: How can I set environment variables that will be known to any process of any service?*
