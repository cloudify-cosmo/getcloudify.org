 ...
 *A:* You will soon be able to point your browser to getcldoudify.org/tryitnow and follow the on screen instructions. This will enable you to test drive Cloudify for a period of 20 minutes without downloading or installing any software.*
 ...
 *A:* Yup.  Cloudify supports Vagrant based installation, which means for testing purposes or any other reason you may have, you can bootstrap Cloudify on your local environment and get started. Read how "here.":http://getcloudify.org/guide/3.0/quickstart.html
...
* Integration with OpenStack core and infrastructure services, which usually that includes this full "OpenStack component":http://getcloudify.org/2014/07/18/openstack-wiki-open-cloud.html list - as well as those that are continually being developed and added with every release. 
 ...
 *A:* Cloudify comes in the free for life open source version that you are able to fork : and customize to your needs, and a Premium edition that includes all of the open source edition's features, and some other goodies.  Learn more about the two versions "here,":http://www.gigaspaces.com/cloudify-cloud-automation/go-pro, and feel free to "get in touch":mailto:info@cloudifysource.org?subject:I'd like to hear more about Cloudify Premium. if you'd like to here more.
 ...
 *A:* Can we be corny? We value each and every Cloudify user and community member, so if you have any ideas or feature requests, we love to keep innovating, so definitely reach out and let us know what you’re thinking.

 There’s no open source tool without an awesome community to back it.  We hope the site provides you with all the resources you’ll need - docs, blog, video tutorials and more.  And this is the link to our forum.  Be sure to join us and don’t be shy to reach out.
