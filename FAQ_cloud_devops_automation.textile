 ...
 *A:* Download it "here":http://getcloudify.org/downloads/get_cloudify_3x.html, and then head over to the "Getting Started":/guide/3.1 guide, and follow the instructions. 
 ...
 *A:* Yup, see above. Cloudify enables you to leverage any Chef cookbook or Puppet manifest.  So working with either tool is really intuitive with Cloudify.  We have a whole area dedicated to using "Chef":http://getcloudify.org/chef_cloud_configuration_management.html with Cloudify, and you can check out how to get started with the "Puppet plugin here":http://getcloudify.org/guide/3.1/plugin-puppet.html. So be sure to check it out if you're using one of these tools.*
 ...
 *A:*  For running the Cloudify CLI, you need to have JDK 1.6 or higher installed, and set the JAVA_HOME environment variable to point to the JDK installation home. When running on clouds such as OpenStack or Amazon, you need to have proper IaaS credentials and set them properly in Cloudify. For more details, please see our "guide":http://getcloudify.org/guide/installation-cli.html.
 ...
 *A:* Cloudify supports pretty much "any cloud":http://getcloudify.org/cloud_orchestration_cloud_automation.html#HPLink.  No wait it’s true - hear us out.  There are clouds that are supported out of the box with already available "plugins":http://getcloudify.org/guide/3.1/quickstart.html - the most common clouds OpenStack, CloudStack, Softlayer, AWS and a bunch of others, you can check out our documentation for the full list.
...
To get started just follow our "quick start guide":http://getcloudify.org/guide/3.1/guide-blueprint.html.
 ...
 *A:* Yup.  Cloudify supports "Vagrant based installation":http://getcloudify.org/downloads/get_cloudify_3x.html, which means for testing purposes or any other reason you may have, you can bootstrap Cloudify on your local environment and get started. Read how "here.":http://getcloudify.org/guide/3.1/quickstart.html
