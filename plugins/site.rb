module Jekyll
  ...
  class Site
    ...
    def site_payload
		...
		payload["categories"]=["Getting Started","Product Overview","Installation & Setup","Bootstrapping","Developing Recipes","Deploying Services & Applications","Undeployment","Monitoring Your Applications","Developing Cloud Drivers", "Plugins and Probes","API","Recipe Reference","Release Notes","FAQ"]
