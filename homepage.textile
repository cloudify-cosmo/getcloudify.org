                    ...
                    <tr>
                        ...
                        <div class="replaceWrape box1">
                           <div class="sec-discusBox">
                            ...
                            <a href="http://forums.cloudifysource.org">More</a>
                           </div>
                           <img src="images/home/hp-Discuss-bg.png" />
                         </div>
                           <a class="hoverState" href="http://forums.cloudifysource.org">
                    ...
                    <tr height="47">
                      ...
                      <tr>
                        ...
                        <div class="replaceWrape box1">
                            ...
                            <br />
                            <a href="http://wwww.cloudifysource.org/cloudifysourcetv">More</a>
                           </div>
                           <img src="images/home/hp-watch-bg.png" />
                         </div>  
                         <a  class="hoverState" href="http://wwww.cloudifysource.org/cloudifysourcetv">
    ...
    <!--end banner -->
                 ...
                 <div class="hp-left-col">
                      ...
                      <div class="recentUpdates-box">
                         {% for post in site.posts limit:1 %}<a href="{{ post.url }}">{{ post.title }} <br/>tamir{% endfor %}	
                      </div>
                      <div class="clear"></div>
                       <!-- update events -->
                      <a href="http://www.rsscalendar.com/feed.aspx?t=a&k=e02f88b4f901971d41c8dd859e6de02a" class="hp-update-icon hp-update-evets">Upcoming Events</a>

                      <div class="recentUpdates-box">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In id porttitor felis. Pellentesque pharetra, libero eget eleifend pretium, diam diam porta odio, eget placerat est mi sed tortor.
                      </div>
                      <div class="clear"></div>
