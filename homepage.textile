...
---                
    ...
    <!--end banner -->
                 ...
                 <div class="hp-left-col">
                      ...
                      <div class="recentUpdates-box">
                        <a href="/participate">Event: Cloud Computing Summit at The DevOps PaaS Infusion</a><br>Join us for Cloudify-sponsored and led meetup in NYC...
					  </div>
                      <div class="clear"></div>
                 ...
                 <div class="hp-right-col">
                    ...
                    <!-- <div class="hp-facebook">
                             <script src="http://static.ak.connect.facebook.com/js/api_lib/v0.4/FeatureLoader.js.php" type="text/javascript"></script>
                                ...
                                <!-- FBML <fb:fan profile_id="7169711435" connections="10" width="240" height="240" css="/css/template.css?25"></fb:fan>                                FBML -->
