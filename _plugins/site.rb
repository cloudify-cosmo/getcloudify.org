  ...
  class Site
    ...
    def site_payload
        ...
        docs_local.each do |page|
		    ...
		    payload["categories"]=["Getting Started","Release Notes","Installation & Setup","Bootstrapping","Developing Recipes","Common Patterns","Deploying Services & Applications","Monitoring Your Applications","Developing Cloud Drivers", "Plugins and Probes","Integration","REST API","Reference","Contributing", "User Interface"]
        payload["categories_3"]=["Installation", "Guides", "Product Overview", "Reference", "Plugins", "User Interface"]
