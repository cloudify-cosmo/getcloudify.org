    ...
    <ul class="downloadList">
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <a id="downloadme"   target="_blank" href="#" style="display: none;"></a>
		<br/>
...
$(".dwnGoBtn").click(function(){
    window.location.href = "http://repository.cloudifysource.org/org/cloudifysource/2.3.0-RELEASE/gigaspaces-cloudify-2.3.0-ga-b3500.zip";
});
