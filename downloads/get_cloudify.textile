					...
					<div class="span12">
						<div class="wrapper">
							<div class="testimonial">
								...
								<p></p>
								<p class="text">
                                <a class="btn btn-default dwnGoBtn" id="downloadme" href="http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-2.7.0-ga-b5996.zip">Go ! <i class="icon-double-angle-right"></i></a> 
