...
<div class="contentNoRight">
    <ul class="downloadList">
		<li><h4 class="impt">We have found that the latest Oracle JDK update causes a logging level error.
Rolling back to a previous JDK will solve the issue. 
In our labs , we use "1.6.0_30" and 1.7.0_04 and they both work well.
We are working on a fix now and we'll update ASAP.</h4> 
</li>
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <p>Get the latest Cloudify GA release - version 2.3.0!</p>
                <!--<a href="/thank_you.htm" class="dwnGoBtn" onclick="trigger_download();"></a>-->
 		<!--<div class="dwnGoBtn"></div>-->
                <a class="dwnGoBtn" id="downloadme"   target="_blank" href="http://repository.cloudifysource.org/org/cloudifysource/2.3.0-RELEASE/gigaspaces-cloudify-2.3.0-ga-b3500.zip" style="display: block;"></a>
		<br/>
		<p><a href="http://www.cloudifysource.org/guide/2.3/release_notes/release_notes" target="_blank" >View the <b>release notes</b></a>.</p>
            </div>
            <div class="clear"></div>
        </li>
        ...
        <li>
            ...
            <div class="dwnListRight">
				...
				<!--
				<p>We just released the GA of version 2.3.0 and we're now working on our next build.  Stay tuned.</p> 
				-->
...
//	});
	...
	$("a#downloadme").click(function(e) {
	       e.preventDefault();
	       window.location = 'http://repository.cloudifysource.org/org/cloudifysource/2.3.0-RELEASE/gigaspaces-cloudify-2.3.0-ga-b3500.zip';
