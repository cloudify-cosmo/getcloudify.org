    ...
    <ul class="downloadList">
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <p id="versionName" >Get the latest Cloudify GA release - version 2.2.0!</p>
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <p id="versionName">Get involved by browsing, forking and contributing to the Cloudify source code on GitHub</p>
...
$(function(){ 
	...
	var verName=$('a#downloadme').attr('href');
	verName.split("/")[6];//for event version name by the download file
	    mixpanel.track_links('#downloadme', "Product Download - "+$(verName).val()); 
	});
});
</script>
