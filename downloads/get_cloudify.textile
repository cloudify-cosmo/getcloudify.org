    ...
    <ul class="downloadList">
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <p>Get the latest Cloudify GA release - version 2.3.1.1 !</p>
                <!--<a href="/thank_you.htm" class="dwnGoBtn" onclick="trigger_download();"></a>-->
 		<!--<div class="dwnGoBtn"></div>-->		         
                <a class="dwnGoBtn" id="downloadme"   target="_blank" href="http://repository.cloudifysource.org/org/cloudifysource/2.3.1.1-RELEASE/gigaspaces-cloudify-2.3.1.1-ga-b3720.zip" style="display: block;"></a>
		<br/>
		<p><a href="/guide/2.3/release_notes/release_notes" target="_blank" >View the <b>release notes</b></a>.</p>
            </div>
            <div class="clear"></div>
        </li>
...
//	});
	...
	$("a#downloadme").click(function(e) {
	       e.preventDefault();
	       window.location = 'http://repository.cloudifysource.org/org/cloudifysource/2.3.1.1-RELEASE/gigaspaces-cloudify-2.3.1.1-ga-b3720.zip';
