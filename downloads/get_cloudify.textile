					...
					<div class="span12">
						<div class="wrapper">
							<div class="testimonial">
								...
								<p></p>
								<p class="text">
                                <a class="btn btn-large btn-theme btn-rounded dwnGoBtn" id="downloadme" href="	<span class="info"><a class="downloadme" href="https://s3-eu-west-1.amazonaws.com/gigaspaces-repository-eu/org/cloudifysource/community/gigaspaces-cloudify-2.7.0-ga-b5996.zip">Go ! <i class="icon-double-angle-right"></i></a> 
