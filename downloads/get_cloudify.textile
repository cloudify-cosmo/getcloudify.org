						...
						<div class="wrapper">
							<div class="testimonial">
								...
								<div class="author">
									...
									<span class="info"><a class="downloadme" href="https://s3-eu-west-1.amazonaws.com/gigaspaces-repository-eu/org/cloudifysource/community/gigaspaces-cloudify-2.7.0-ga-b5996.zip">Download</a> the latest stable version</span>
										<p><h4><strong>IMPORTANT NOTE#1: WE APOLOGIZE ABOUT THE ISSUE WITH BOOTSTRAPPING THE CLOUDIFY MANAGER.  WE HAD AN ISSUE WITH OUR DOMAIN CHANGE AND WE ARE WORKING ON FIXING THIS IMMEDIATELY.  YOUR UNDERSTANDING AND PATIENCE IS MUCH APPRECIATED.  WE'RE VERY SORRY ABOUT THE INCONVENIENCE.</strong></h4></p>
										<p><br/><h4 class="impt">IMPORTANT NOTE#2: JDK 7u51 & 6u30 do not work properly with JClouds, since those releases broke the compatibility with Google Guava. Therefore, Cloudify jclouds cloud drivers cannot run with it. You can use 7u45 or earlier versions.For more info, please read <a href="https://cloudifysource.atlassian.net/browse/CLOUDIFY-2378">this</a>.</h4></p>
								</div>
								<p></p>
								<p class="text">
                                <a class="btn btn-large btn-theme btn-rounded dwnGoBtn" id="downloadme" href="https://s3-eu-west-1.amazonaws.com/gigaspaces-repository-eu/org/cloudifysource/community/gigaspaces-cloudify-2.7.0-ga-b5996.zip">Go ! <i class="icon-double-angle-right"></i></a> 
					...
					<div class="span4">
						<div class="wrapper">
							<div class="testimonial">
									...
									<span class="info"><a class="dwnGoBtn" target="_blank"  href="https://github.com/CloudifySource/cloudify" ><strong>Fork the code on Github - and get involved. </strong></a> </span>
							</div>
						</div>
						</div>
						<div class="span4">
