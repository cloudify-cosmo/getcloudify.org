        ...
        <li>			
           <div class="dwnListLeft">
            ...
            <div class="dwnListRight">
                ...
                <h4 class="impt">JDK 7u51 does not work properly with JClouds, since 7u51 broke the compatibility with Google Guava. Therefore, Cloudify jclouds cloud drivers cannot run with it. <br/>
