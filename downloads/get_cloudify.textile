    ...
    <ul class="downloadList">
        ...
        <li>
 		...
 		<!--<div class="dwnGoBtn"></div>-->		         
                <a class="dwnGoBtn" id="downloadme"   target="_blank" href="http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-2.5.1-ga-b4200.zip" style="display: block;"></a>
		<br/>
...
//	});
	...
	$("a#downloadme").click(function(e) {
	       e.preventDefault();
	       window.location = 'http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-2.5.1-ga-b4200.zip';
