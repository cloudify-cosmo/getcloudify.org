    ...
    <ul class="downloadList">
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <a href="/thank_you.htm" class="dwnGoBtn" onclick=""></a>
                <a id="downloadme"   target="_blank" href="http://repository.cloudifysource.org/org/cloudifysource/2.3.0-RELEASE/gigaspaces-cloudify-2.3.0-ga-b3500.zip" style="display: none;"></a>
		<br/>
...
//window.location.replace = $('#downloadme').attr('href');
document.getElementById('downloadme').click();
_gaq.push(['_trackPageview', downloadme]);
}

$('a.dwnGoBtn').mouseup(function(e){ // fix for chrome and safari
e.preventDefault();
document.getElementById('downloadme').click();
});
