        ...
        <li>			
           <div class="dwnListLeft">
            ...
            <div class="dwnListRight">
                ...
                <p>Get the latest Cloudify GA release - version 2.7.0 !</p>
                <h4 class="impt">JDK 7u51 & 6u30 do not work properly with JClouds, since those releases broke the compatibility with Google Guava. Therefore, Cloudify jclouds cloud drivers cannot run with it. <br/>
				You can use 7u45 or earlier versions. <br/>
For more info, please read <a href="https://cloudifysource.atlassian.net/browse/CLOUDIFY-2378" target="_blank">this</a>		
				</h4>
                <!--<a href="/thank_you.htm" class="dwnGoBtn" onclick="trigger_download();"></a>-->
 		<!--<div class="dwnGoBtn"></div>-->		         
                <a class="dwnGoBtn" id="downloadme" href="http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-2.7.0-ga-b5996.zip" style="display: block;"></a>                
		<br/>
		<p><a href="/guide/2.7/release_notes/release_notes" target="_blank" >View the <b>release notes</b></a>.</p>
            </div>
            <div class="clear"></div>
        </li>
		...
		<li id="latest">
            <div class="dwnListLeft">
                <img src="/images/imgDwnGetReady.png"  alt="Test Drive a Nightly Build" width="145" height="152"/>
            </div>
            <div class="dwnListRight">
                <h3>Latest Nightly Build of Cloudify</h3>
				
				<p>Get the latest nightly build of Cloudify</p>
				<h4 class="impt">This build is <b>not</b> an official public release and it hasn't been properly tested, but it can serve devlopers in testing new features and bug fixes.</h4>
                <a class="dwnGoBtn" id="downloalatestbuild" href="http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-nightly-build.zip" style="display: block;"></a>
            </div>
            <div class="clear"></div>
        </li>
