						...
						<div class="wrapper">
							<div class="testimonial">
								...
								<div class="author">
									...
									<p class="name">
										<h2><span class="highlight"><strong>Get the GA Release</strong></span></h2>
									</p>
									<span class="info"><a class="downloadme" href="http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-2.7.0-ga-b5996.zip">Download</a> the latest stable version</span>
								</div>
								<p></p>
								<p class="text">
                                <a class="btn btn-large btn-theme btn-rounded dwnGoBtn" id="downloadme" href="http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-2.7.0-ga-b5996.zip">Go ! <i class="icon-double-angle-right"></i></a> 
                                <button type="button" data-toggle="collapse" data-target="#collapsible" class="btn btn-large btn-theme btn-rounded btn-toggle"><i class="icon-book"></i>Release Notes  </button>
					...
					<div class="span4">
						<div class="wrapper">
							<div class="testimonial">
									...
									<span class="info"><a class="dwnGoBtn" target="_blank"  href="https://github.com/CloudifySource/cloudify" >Fork the code on Github - and get involved </a> </span>
							</div>
						</div>
						</div>
						<div class="span4">
