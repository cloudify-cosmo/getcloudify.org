    ...
    <ul class="downloadList">
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <p>Get the latest Cloudify GA release - version 2.6.1 !</p>
                <!--<a href="/thank_you.htm" class="dwnGoBtn" onclick="trigger_download();"></a>-->
 		<!--<div class="dwnGoBtn"></div>-->		         
                <a class="dwnGoBtn" id="downloadme" href="http://repository.cloudifysource.org/org/cloudifysource/community/gigaspaces-cloudify-2.6.1-ga-b5200.zip" style="display: block;"></a>
		<br/>
