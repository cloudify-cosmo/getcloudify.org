...
<div class="contentNoRight">
    <ul class="downloadList">
		...
		<p><a href="http://www.cloudifysource.org/guide/2.2/release_notes/release_notes">View the <b>release notes</b></a>.</p>
            </div>
            <div class="clear"></div>
        </li>
...
_gaq.push(['_trackPageview', '/downloads/cloudify-2.1.1-ga-b1400/get_cloudify']);
...
<script text="javascript">
  ...
  mixpanel.track_links('#downloadme', '/downloads/cloudify-2.1.1-ga-b1400/get_cloudify');
</script>
