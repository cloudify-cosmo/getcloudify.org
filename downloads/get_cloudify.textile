    ...
    <ul class="downloadList">
        ...
        <li>
            ...
            <div class="dwnListRight">
                ...
                <p>Get the latest Cloudify GA release - version 2.5 !</p>
                <!--<a href="/thank_you.htm" class="dwnGoBtn" onclick="trigger_download();"></a>-->
 		<!--<div class="dwnGoBtn"></div>-->		         
                <a class="dwnGoBtn" id="downloadme"   target="_blank" href="http://repository.cloudifysource.org/org/cloudifysource/2.5.0-RELEASE/gigaspaces-cloudify-2.5.0-ga-b4010.zip" style="display: block;"></a>
		<br/>
        ...
        <li>
            ...
            <div class="dwnListRight">
				...
				<p>We just released the GA of version 2.5.0 and we're now working on our next build.  Stay tuned.</p> 
...
//	});
	...
	$("a#downloadme").click(function(e) {
	       e.preventDefault();
	       window.location = 'http://repository.cloudifysource.org/org/cloudifysource/2.5.0-RELEASE/gigaspaces-cloudify-2.5.0-ga-b4010.zip';
