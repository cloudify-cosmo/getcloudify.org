...
<br/>
        ...
        <br/>
		<p class="download"> <a class="eaTitle" href="http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/3.1.0/m3-RELEASE/cloudify-linux64-cli_3.1.0-m3-b80_amd64.deb" onClick="javascript: _gaq.push(['_trackPageview', '/downloads/cloudify-linux64-cli_3.1.0-m3-b80_amd64.deb/early_access']);"> Cloudify Ubuntu/Debian64 CLI M3</a> </p>        	    
        <br/>		
        <p class="download"> <a class="eaTitle" href="http://gigaspaces-repository-eu.s3.amazonaws.com/org/cloudify3/3.1.0/m3-RELEASE/cloudify-windows-cli_3.1.0-m3-b80.exe" onClick="javascript: _gaq.push(['_trackPageview', '/downloads/cloudify-windows-cli_3.1.0-m3-b80.exe/early_access']);"> Cloudify Windows CLI M3  </a></p>        	    
        <br/>

        <h3>Cloudify Advanced Packages</h3>
