			...
			<table style="width:100%;border:0px">
				...
				<tr>
					<td style="width:45%;background-color:transparent;">
						...
						<p>
							The resources below form the individual Cloudify 3 packages that are installed on the server and application VM side. All componets are installed in the manager VM, and the Cloudify agent is installed by default (although this can be overridden) on every new VM that is created by the manager as part of the installation of a specific deployment. Please refer to the <a href="/guide/3.0/installation-general.html">cloudify installation page</a> for more details about each of the packages.  
						</p>
