...
<span class="pullquote-left">
  <h2><font style="font-weight: bold" size="5" face="Baskerville Old Face"><em>Test drive Cloudify and transition your apps on the cloud from Java 7 to Java 8 seamlessly.</em></font>&nbsp; &nbsp; <a class="btn btn-large btn-theme btn-rounded" href="http://getcloudify.org/downloads/get_cloudify.html" target="_blank"><i class="icon-plus"></i> Go </a></h2></span>
