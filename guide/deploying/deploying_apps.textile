...
<img width="700" src="/guide/images/deploy/install-application-success.png">
...
<img width="700" src="/guide/images/deploy/install-application-failed-recipe.png">

The following examples shows the progress of a deployments that failed because the application is already deployed.
<img width="700" src="/guide/images/deploy/install-application-failed-runtime.png">
