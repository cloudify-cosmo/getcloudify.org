...
|<img src="/guide/images/overview/any-stack.jpg" />|Any App|
|<img src="/guide/images/overview/Any-cloud.jpg" />|Any cloud|

ttttt 
<img src="/guide/images/overview/any-stack.jpg" />
bbbb
...
{caption:titlelocation=below|aligntitle=center|type=Figure|num=1|title=Built-In Recipes}
!Built-in-recipes.jpg|align=center!
{caption}
...
{caption:titlelocation=below|aligntitle=center|type=Figure|num=2|title=The Result: Easy Deployment to the Cloud}
!onboard.png|align=center!
{caption}
...
{info:title=Why Is Cloud Portability Important?}
...
{comment}
h1. Cloud Challenges
* *Port you Applications to the Cloud without changing the App*
...
h1. Key Benefits
GigaSpaces PaaS Enablement Platform delivers:
* *Seamless On-boarding of Any Application to the Cloud* 
