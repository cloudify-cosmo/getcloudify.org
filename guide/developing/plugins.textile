...
|*Configuration*|This type of monitor retrieves custom service details. When using *Scripted* probes, it is described in the @details@ section of the service configuration file.|
|*Performance*|This type of monitor retrieves custom metrics at regular intervals. When using *Scripted* probes, it is described in the @monitors@ section of the service configuration file.|
