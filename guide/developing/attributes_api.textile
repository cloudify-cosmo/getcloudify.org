...
The following example shows how to use the @foreach@ method to iterate through the attributes of service instances: @context.attributes.thisService.instances.foreach{println t.myKey}@
