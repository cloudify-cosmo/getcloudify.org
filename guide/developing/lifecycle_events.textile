...
The service context can be retrieved from within event handler scripts or closures using the "Service Context API":/guide/developing/the_service_context_api. The following example shows how to use @ServiceContextFactory@ to retrieve an instance of the service context in a Groovy event handler script:
