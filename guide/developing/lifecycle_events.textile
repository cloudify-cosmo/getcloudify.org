...
* Application uninstall - To uninstall an application, at the Cloudify shell prompt, type: *@uninstall-application@* @<applicationName>@. This command uninstalls the application, stops the services and unprovisions the services in order of dependencies.
