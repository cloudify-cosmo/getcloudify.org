...
Application recipes are the execution plans for installing, starting, orchestrating, and monitoring your application stack without changing the application's code or architecture. Cloudify uses the following types of recipes:

|_. Recipe type |_. Description |
| Application | An application recipe is comprised of the application descriptor file and recipes for the services it requires. |
