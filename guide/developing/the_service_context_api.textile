...
You can use the Attributes API to exchange information between different contexts such as the Application, the Service, and the Service Instance contexts. For more information, see "The Attributes API":/guide/developing/attributes_api.
