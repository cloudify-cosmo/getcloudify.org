...
and start a new Cloudify Application container that uses the data from the exported container. To do so, checkout relevant docker documentation [here](https://docs.docker.com/userguide/dockervolumes)
{%endnote%}
