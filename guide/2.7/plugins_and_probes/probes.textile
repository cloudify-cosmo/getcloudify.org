...
All you need to do is implement the monitors closure as part of your lifecycle closure, returning a @Map@ of @String@ keys with the metric name and a numeric value.
