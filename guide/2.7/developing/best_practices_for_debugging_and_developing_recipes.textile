...
If possible, develop your recipes using the Cloudify "localcloud":http://www.cloudifysource.org/guide/bootstrapping/bootstrapping_localcloud.html .
...
# Use the Cloudify CLI *tail* command as described "here":http://www.cloudifysource.org/guide/recipe/command_line_reference.html#tail. - This will enable you to retrieve the last N lines of a specific service log.
