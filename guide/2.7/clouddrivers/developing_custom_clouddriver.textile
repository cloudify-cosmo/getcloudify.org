...
Sometimes, all we need is to extend an existing cloud driver. The quickest way is to place the new cloud driver class in a groovy file
 in the @<cloudifyRoot>/clouds/cloudProviderName/lib/@ folder.
