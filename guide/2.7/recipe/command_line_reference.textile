...
Once you have installed the "Cloudify shell":../setup/installing_the_cloudify_client , you can start using the commands that the Cloudify shell provides.
...
<script src="https://gist.github.com/tamirko/9364339.js"></script>
"back":#commands
