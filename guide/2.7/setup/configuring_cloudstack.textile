...
2. Go to network
3. Select as network name
4. Go to the Egress rules tab
5. set cdir 0.0.0.0/0 to All and add it
!../../images/cloudstack/configure_network_egress.png!
6. Go to details tab and select View IP Addresses
7. Click Aquire New IP for your virtual machine
!../../images/cloudstack/aquire_new_ip.png!
8. Click the IP you created and configure firewall and Port forwarding
!../../images/cloudstack/configure_firewall_and_port_forwarding.png!
9. configure the firewall port and cidr of vm
