...
* An "(newwindow)CloudStack Cloud":http://www.hpcloud.com/ account
...
# In the CloudStack web console, under "Key Pairs":https://manage.hpcloud.com/compute/100/keypairs, click *Create Key Pair*, and then type a name for the key pair.
!../../images/hp/compute_create_new_key_pair_hp_cloud_services.png!
# Copy the key and save it as a @.pem@ private key file (e.g. @myKeyPair-name.pem@) in the @<cloudifyRoot>/clouds/CloudStack/upload@ folder.
...
You can obtain your *Access Key* and *Secret Access Key* from the "(newwindow)API Keys":https://manage.hpcloud.com/account/api_keys section of the CloudStack web console, as follows:
