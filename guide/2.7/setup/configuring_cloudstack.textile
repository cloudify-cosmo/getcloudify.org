...
Image, location and hardware IDs determine the hardware profile and operating system image of the VMs Cloudify will create on CloudStack. Note that in the CloudStack lingo, hardware IDs correspond to compute offering IDs, image IDs corresponf to template IDs, and location IDs correspond to regions. In the this cotext we'll use the Cloudify/JClouds terms. You can use the "JClouds CLI":https://github.com/jclouds/jclouds-cli to retreive them. To get the list of hardware IDs and image IDs using this tool, follow the below steps: 
...
You're ready to bootstrap Cloudify on your CloudStack environment. Follow the below link to learn how to do it. 
