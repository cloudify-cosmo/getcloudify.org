...
<br/>
* Also can get the image, hardware and network IDs
** copy the ID filed from the web console
** use "jcloud CLI":http://search.maven.org/remotecontent?filepath=org/jclouds/cli/jclouds-cli/1.6.0/jclouds-cli-1.6.0.zip command line
*** download jcloud CLI and extract it
*** navigate to the extracted folder /bin and run @jcloud-cli@ command
*** install cloudstack feature 
<br/>
