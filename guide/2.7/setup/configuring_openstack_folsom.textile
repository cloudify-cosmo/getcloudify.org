...
h2. Bootstrapping Openstack Folsom Cloud

h3. Prerequisites

Before you bootstrap your Openstack Folsom Cloud, make sure that your environment meets all the minimum requirements. For more information, see "Bootstrapping Prerequisites":../bootstrapping/bootstrapping_process#prereqs.

h3. Bootstrapping

Bootstrapping Openstack Folsom Cloud is extremely simple:
...
# Start the bootstrapping process for provisioning machines for Cloudify management -- At the Cloudify shell prompt, type: *@bootstrap-cloud@* *@openstack-folsom@*
...
To shut down the Openstack Folsom Cloud environment, at the Cloudify shell prompt, type: *@teardown-cloud@* @openstack-folsom@
