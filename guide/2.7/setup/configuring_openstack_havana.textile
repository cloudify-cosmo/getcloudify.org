...
<h4 class="impt">You can set the cloud driver directly as shown in the following example (of an @openstack-havana-cloud.groovy@ file), but we reccomend that you use "parameterization of the cloud driver configuration":../clouddrivers/cloud_driver#gstr, </h4>
<span id="cd"></span>
...
Before you bootstrap your Openstack Havana Cloud, make sure that your environment meets all the minimum requirements. For more information, see "Bootstrapping Prerequisites":../bootstrapping/bootstrapping_process#prereqs.
