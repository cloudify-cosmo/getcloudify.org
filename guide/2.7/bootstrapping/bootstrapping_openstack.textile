...
Before you bootstrap your OpenStack Cloud, make sure that your environment meets all the minimum requirements. For more information, see "Bootstrapping Prerequisites":../bootstrapping/bootstrapping_process#prereqs and "Configuring OpenStack":../setup/configuring_openstack.
