...
<!-- 
Due to threading limitations, we reccomend that you install 10 service instances at a time by using the "set-instances":../recipe/command_line_reference#set_instances CLI command.
-->
