...
h4. One of the best things about Cloudify is that you don't need to change your recipe at all when you want to switch between public cloud providers, nor do you have to install anything on "your" cloud prior to using Cloudify.
...
h4. In order for Cloudify to help you meet your needs, you need to give us an additional information such as :
...
h4. Here's an example of ec2-cloud.groovy(For Amazon EC2 cloud with placeholders): 

<script src="https://gist.github.com/1722422.js?file=ec2-cloud.groovy"></script>

h4. You can find more regarding Bootstrapping+on+EC2 in "http://www.gigaspaces.com/wiki/display/CLOUD/Bootstrapping+on+EC2":http://www.gigaspaces.com/wiki/display/CLOUD/Bootstrapping+on+EC2
