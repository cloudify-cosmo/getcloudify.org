...
|{color:red}azure:bootstrap-app|Starts Azure Role Instances based on the specified application description. |
|{color:blue important;}azure:connect-app|Connects to a bootstrapped application. |
