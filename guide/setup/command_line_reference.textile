...
This is "a test1":#x5 and this is "test2":#x6
This is "a test3":#x5 and this is "test4":#x6
...
|(#x5)clear|Clears the console. |
(#x6)|connect|Connects to the target admin REST server |
|disconnect|Disconnects the admin REST server |
|exit|Terminates the shell |
(x5)|help|Lists all available commands |
|(x5)install-application|Installs an application. If you specify a folder path it will be packed and deployed. If you sepcify an application archive, the shell will deploy that file.|
