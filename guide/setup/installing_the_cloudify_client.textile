...
# "Download(Click here to download the Cloudify distribution file)":http://bit.ly/ztbg9u and unzip the Cloudify distribution file.

h2. To start the Cloudify shell

Go to the @<Cloudify Installation Folder>/tools/cli@ folder, and then run @cloudify.bat@ (Windows) or @cloudify.sh@ (*nux) depending on the operating system running on your machine.
