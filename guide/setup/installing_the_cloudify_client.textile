...
* Go to the @<cloudifyInstallationFolder>/tools/cli@ folder, and then run @cloudify.bat@ (Windows) or @cloudify.sh@ (*nix) depending on the operating system running on your machine.
