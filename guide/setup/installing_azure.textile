...
* Unzip WorkerRoles.zip to c:\cloudify\tools\cli\plugins\azure (Which would create c:\cloudify\tools\cli\plugins\azure\WorkerRoles)
* Unzip travel-withproxy.zip to c:\cloudify\examples (Which would create c:\cloudify\examples\travel-withproxy )
