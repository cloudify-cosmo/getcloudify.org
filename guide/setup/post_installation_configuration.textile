...
Before deploying the application, you must configure the recipe that will be used for the deployment. For more information about recipes, see "Anatomy of a Recipe":/guide/developing/recipes_overview.
