...
h3. Downloading Cloudify Chef Recipes and Related Artifacts
...
h4(info). Alternatively, you can configure Cloudify to use an existing Chef Server by setting this attribute manually using the Cloudify shell. This can be a Chef server you installed separately or the "Hosted Chef":http://www.opscode.com/hosted-chef/ service.
...
*@invoke@* @updateCookbooks@ _@tar 'http://repository.cloudifysource.org/chef-cookbooks/mysql_cookbook_with_deps.tgz'@_
...
h2. TL;DR - How Does Cloudify Use Chef?
