...
h2. Installing Cloudify with Chef
...
* Using knife -- see "NEED A URL DOC NAME FOR HERE":AND-A-URL-FOR-HERE.
...
h2. Cloudify-Chef Integration Under the Hood

This section explains how Cloudify wraps a chef cookbook and runs it.
