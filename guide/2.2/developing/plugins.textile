...
Cloudify recipes can use probes and plugins for monitoring service configuration, performance, and availability. The collated performance metrics can be "configured":../developing/configuring_ui_section to display in the *Metrics* pane of the Cloudify web management console.
...
* Scripted Probes
<img src="../2.2/images/recipes/builtin_plugin.png"/>

* Plugin Probes
<img src="../2.2/images/recipes/custom_plugin.png"/>
...
<img src="../2.2/images/recipes/monitoring_cycle.png"/>

h2. See Also

* "Using Probes":../plugins_and_probes/probes
* "Using Plugins":../plugins_and_probes/develop_your_plugin