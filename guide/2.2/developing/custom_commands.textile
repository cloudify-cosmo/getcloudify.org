...
The @customCommands@ section must be located in the "@General@":../developing/service_recipe section of the relevant service descriptor file (@<service name>-service.groovy@). The following example shows the @customCommands@ section after the @lifecycle@ section, in the @General@ section of the service desciptor file.
