...
<table class="overviewtable">
    <tr>
        <td><img src="/guide/2.2/images/overview/any-stack.jpg"/></td>
    ...
    <tr>
        <td><img src="/guide/2.2/images/overview/Any-cloud.jpg"/></td>
    ...
    <tr>
        <td><img src="/guide/2.2/images/overview/Full-control.jpg"/></td>
...
<table class="overviewtable">
    <tr>
        <td><img src="/guide/2.2/images/overview/recipe-config.png"/></td>
    ...
    <tr>
        <td></td>
        <td><img src="/guide/2.2/images/overview/Built-in-recipes.jpg" title="Built-In Recipes"/></td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td><img src="/guide/2.2/images/overview/usm.png"/></td>
    ...
    <tr>
        <td><img src="/guide/2.2/images/overview/Cluster-Aware-Monitoring.jpg"/></td>
    ...
    <tr>
        <td></td>
        <td><img src="/guide/2.2/images/overview/onboard.png"/></td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td><img src="/guide/2.2/images/overview/architecture.jpg"/></td>
    </tr>
    <tr>
        <td></td>
...
<table class="overviewtable">
    <tr>
        <td width="10%" valign="top">
            <img src="/guide/2.2/images/overview/no-lockin.jpg"/>
        </td>
    ...
    <tr>
        <td width="10%" valign="top">
            <img src="/guide/2.2/images/overview/Any-cloud.jpg"/>
        </td>
        <td width="70%" valign="top">
...
<table class="overviewtable" border="0">
    <tr>
        <td width="5%"><img src="/guide/2.2/images/overview/any-stack.jpg"/></td>
        ...
        <td width="10%"></td>
        <td width="5%">
            <img src="/guide/2.2/images/overview/Automation-of-the-Entire-Lifecycle.jpg"/>
        </td>
        <td width="30%" valign="top">
    ...
    <tr>
        <td>
            <img src="/guide/2.2/images/overview/Automatic-Self-hEALING.jpg"/>
        </td>
        <td width="30%" valign="top">
    ...
    <tr>
        <td>
            <img src="/guide/2.2/images/overview/Auto-Scale.jpg"/>
        </td>
        <td width="30%" valign="top">
            *Auto-Scale, Your Way*
        ...
        <td>
            <img src="/guide/2.2/images/overview/Cluster-Aware-Monitoring.jpg"/>
        </td>
        <td width="30%" valign="top">
    ...
    <tr>
        ...
        <td width="10%"></td>
        <td>
            <img src="/guide/2.2/images/overview/fullytestable.jpg"/>
        </td>
        <td width="30%" valign="top">
