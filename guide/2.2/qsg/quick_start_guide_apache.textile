...
* Use an example recipe to deploy an application on a "Local Cloud":../bootstrapping/bootstrapping_localcloud using Cloudify, from the installation of Cloudify iteself, deployment of your applocation and finally monitoring you deployed application using Cloudify's management tools.
* Use the Cloudify interactive shell.
* Monitor your deployed application, using Cloudify's "Web Based Management Console":../monitoring/the_web_management_console.
...
<img src="../2.2/images/setup/shell_start2.jpg" width="630" height="300" />
...
<img src="../2.2/images/setup/shell_boot3.jpg" width="630" height="300" />
...
Cloudify comes with "built-in plugin implementations":../plugins_and_probes/develop_your_plugin that you can configure as needed, but you can also develop your own monitoring plugins and pack them with the recipe (in jar files under usmlib sub-folder within each service folder).
...
To monitor the application open a web browser (the latest versions Firefox or Chrome, IE is not fully supported at this point) and log into the "Web Management Console":../monitoring/the_web_management_console (The shell gives you the exact URL when bootstrapping the localcloud). Usually it would be "http://localhost:8099":http://localhost:8099. You don't need to specify any username or password, just click the login button to login anonymously.
...
<img src="../2.2/images/qsg/petclinic.png" width="600"/>
...
* Learn how to further monitor your application with the "Web Based UI":../monitoring/the_web_management_console.