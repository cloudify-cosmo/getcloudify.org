...
# Go to the @<cloudify installation folder>/bin@ folder, and then run @cloudify.bat@ (Windows) or @cloudify.sh@ (Linux) depending on the operating system running on your machine.
  <img src="/guide/2.2/images/setup/shell_start2.jpg" width="630" height="300" />
...
<img src="/guide/2.2/images/setup/shell_boot3.jpg" width="630" height="300" />
...
<img src="/guide/2.2/images/setup/pet_clinic_anatomy4_211ga.jpg" />

h4(info). The *mongod* service extends the mongod service in ../../../services/mongodb/mongod and the 
      and the *tomcat* service extends the tomcat service in ../../../services/mongodb/tomcat and the 

For more information about recipes, see "Anatomy of a Recipe":/guide/developing/recipes_overview
...
Once the application installation has successfully completed, you can access the PetClinic application by browsing to "http://localhost:8080/petclinic":http://localhost:8080/petclinic.
...
<img src="/guide/2.2/images/setup/petClinic_in_webui_screenShot4.jpg" width="630" height="300"/>
...
<h4 class="impt">To see it in action, <a href="http://www.cloudifysource.org/cloudifysourcetv#bUmt6NX7M9I" rel="bUmt6NX7M9I" class="youtube wtd" data-bitly-type="bitly_hover_card">click here</a> to watch the demo.</h4>

h1. What's Next?

* Install the extended PetClinic Application on "EC2":/guide/qsg/quick_start_guide_ec2.
