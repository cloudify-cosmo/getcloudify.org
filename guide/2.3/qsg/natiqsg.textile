---
layout: default
title: A Quick Start Guide for Cloudify
cat: Getting Started
publish: false
abstract: A quick start guide to Cloudify
pageord: 599
--- 
...
In this cloud driver, you need to set your API key , SSH key information etc., as described in the list below.

The following is a list of supported cloud providers configurations:

* "Amazon EC2":../setup/configuring_ec2
* "HP OpenStack Cloud":../setup/configuring_openstack
...
## Bootsrap Cloudify management on your cloud provider
       Type *_@boootsrap-cloud cloudProviderName@_* on your Cloudify shell.
	   e.g.:
        For EC2, type : Type *_@boootsrap-cloud ec2@_* 
        For OpenStack, type : Type *_@boootsrap-cloud openstack@_* 
        For Azure, type : Type *_@boootsrap-cloud azure@_* 
        For RackSpace, type : Type *_@boootsrap-cloud rsopenstack@_* 
        For BYON, type : Type *_@boootsrap-cloud byon@_* 	   
