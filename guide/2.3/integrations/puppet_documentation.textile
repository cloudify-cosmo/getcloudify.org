...
Example (the following will write the myname attribute of the hello-puppet application):
 <span class="snippet">file { 'my-name': path => '/tmp/myname', ensure => present, mode => 0666, content => get_cloudify_attribute('myname', 'application'), } 
 </span>
...
<span class="snippet">
cloudify_attribute { 'myname': value => 'Inigo Montoya', type => 'application', ensure => present, application => 'hello-puppet' }
</span>
