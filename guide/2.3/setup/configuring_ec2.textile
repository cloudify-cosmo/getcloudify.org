...
<script src="https://gist.github.com/tamirko/3273680.js"></script>

<span id="ec2driver"></span>
<h4 class="impt">To learn how to get the credentials and all the other details and how to use them, <a href="http://www.youtube.com/watch?v=jYOiqlQL1o8" rel="jYOiqlQL1o8" class="video fancybox-media">click here</a>.</h4>
