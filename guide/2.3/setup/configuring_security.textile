...
Your code should use spring-security-core version 3.1.3.RELEASE.
...
•	Extend class:
org.cloudifysource.rest.security.CustomAuthenticationToken

h4. Deploy

•	Compile your code and create a jar file. Copy the jar to <cloudify_home>\lib\required.
•	Create a jar file.
•	Copy the jar to <cloudify_home>\lib\required.
...
Configure spring-security.xml to use your custom authentication provider:
	...
	<bean id="myAuthProvider" class="com.AuthProvider.MyAuthProvider"/>
