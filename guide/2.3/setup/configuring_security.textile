...
<span id="autha"/>Here is a list of actions and their corresponding authorized roles.
...
h4(impt). Actions regarding Applications/Services/instances are always applicable only for in the scope of the authorization-groups the user belongs to
