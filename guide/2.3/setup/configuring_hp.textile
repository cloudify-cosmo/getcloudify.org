...
* In the *user* section:
** *user*--Specify your credentials *Access Key ID:Tenant Name*. The Access Key ID is *NOT* the tenant ID and the Tenant Name is usually the account's email address.
e.g : 64576452:joe@friends.com. Refer to the "(newwindow)HP console":https://console.hpcloud.com/account/api_keys for these details.
