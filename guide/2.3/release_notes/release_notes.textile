...
* "DSL Overrides":../recipe/command_line_reference#install_app - Enables users to override application and service level properties in all the services of an application, by setting the value of the *-overrides* argument.
...
* "(newwindow)JClouds 1.5.2":http://www.jclouds.org/documentation/releasenotes/1.5/ - Cloudify now supports JClouds 1.5.2 GA.
