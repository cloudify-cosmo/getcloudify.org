...
During Installation you can use an external properties file to override properties in the service recipe.
To do so use the install-service commands with the -overrides flag, pointing to external properties file.
