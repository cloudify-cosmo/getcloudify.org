...
During Installation you can use an external properties file to override properties in the application and services recipes.
To do so use the install-application commands with the -overrides flag, pointing to external properties file.
