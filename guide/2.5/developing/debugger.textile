...
The debugger allows user to pause the recipe execution in any of the following scenarios :
...
The user can specify if the debug pause applies to a specific lifecycle script or to all scripts.
...
<a class="fancybox-media" href="../../images/developing/tomcat_in_webui.jpg"><img src="../../images/developing/tomcat_in_webui_thumb.jpg" alt="pic is missing" /></a>
 
3. Ssh to tomcat VM and invoke the following command *@debug@* on the tomcat VM.
