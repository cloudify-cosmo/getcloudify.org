...
<h4 class="impt">Check out <a href="/cloudifysourcetv#sqStQrvfgtg" rel="sqStQrvfgtg" class="youtube wtd" data-bitly-type="bitly_hover_card">this demo</a> to learn how to bootstrap Cloudify on a local cloud and install a recipe.</h4>
