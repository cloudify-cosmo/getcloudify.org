...
h2(#q12). *What does the test-recipe command do?*
...
h2(#q13). *Where will the serviceDirectory point to?*
 ...
 *A:* No. 
      ...
      Assuming that your service is named myService:
       The 1st instance's working directory will be myService_1 and the second's will be myService_2.
