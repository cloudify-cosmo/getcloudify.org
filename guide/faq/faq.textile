...
* *On localcloud:*
 The 1st instance's working directory will be &lt;Cloudify Root&gt;/work/processing-units/myApp_myService_1/ext and the second's will be &lt;Cloudify Root&gt;/work/processing-units/myApp_myService_2/ext.<br/>
* *On a real cloud:* 
  The 1st instance's working directory will be remoteDirectory/work/processing-units/myApp_myService_1/ext and the second's will be remoteDirectory/work/processing-units/myApp_myService_2/ext.<br/> 
