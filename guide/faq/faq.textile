 ...
 *A:* We are more than happy to get your controbutions. You can find all the details on how to become a contributor in "this page":/guide/contribute/how_to.
<br/>
"Back to top":#top
<hr/>
...
<h4 class="info"> Note that remoteDirectory should be set in the provider section in &lt;Cloudify Root&gt;/tools/cli/plugins/esc/YOUR_CLOUD_PROVIDER_NAME/YOUR_CLOUD_PROVIDER_NAME-cloud.groovy .</h4>
 ...
 *A:* You can read about Cloudify's prerequisites "here.":/guide/setup/cloudify_prerequisites
 ...
 *A:* We track all our issues in our public "(newwindow)JIRA":https://cloudifysource.atlassian.net.
"(newwindow image)!/guide/images/logoJIRAPNG.png!":https://cloudifysource.atlassian.net 
<br/>
"Back to top":#top
<hr/>
