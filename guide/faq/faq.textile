...
h4(noteYellow). Note that remoteDirectory should be set in the provider section in &lt;Cloudify Root&gt;/tools/cli/plugins/esc/YOUR_CLOUD_PROVIDER_NAME/YOUR_CLOUD_PROVIDER_NAME-cloud.groovy .
