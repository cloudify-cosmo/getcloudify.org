...
<br/>
In general: Cloudify works with *any* cloud that supports the "(external)JClouds":http://www.jclouds.org/ API.
...
h2(#q11). *Is Cloudify open source?*

 *A:* Most of Cloudify's components are open sourced. The sources can be found on "(external)GitHub":https://github.com/CloudifySource/cloudify and are licensed under the "(external)Apache2 license":http://www.apache.org/licenses/LICENSE-2.0 .
