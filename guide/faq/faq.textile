 ...
 *A:* No. 
 <br/>
    ...
    <br/>  Assuming that your application is named myApp and your service is named myService:
    <br/>   On localcloud:   The 1st instance's working directory will be &lt;Cloudify Root&gt;/work/processing-units/myApp_myService_1/ext and the second's will be &lt;Cloudify Root&gt;/work/processing-units/myApp_myService_2/ext.
    <br/>   On a real cloud: The 1st instance's working directory will be remoteDirectory/work/processing-units/myApp_myService_1/ext and the second's will be remoteDirectory/work/processing-units/myApp_myService_2/ext.
	<br/>   remoteDirectory should be set in the provider section in <Cloudify Root>/tools/cli/plugins/esc/YOUR_CLOUD_PROVIDER_NAME/YOUR_CLOUD_PROVIDER_NAME-cloud.groovy .
