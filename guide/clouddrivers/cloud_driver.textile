...
How it works
The cloud driver is basically a Java POJO. It’s class name is part of the cloud configuration file (*-cloud.groovy). Cloudify will instantiate this class (using the no-arg constructor) as required and delegate scale out/in requests to it. 
