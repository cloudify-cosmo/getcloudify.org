...
The Attributes API allows to retrieve values of attributes from other service instances in the same cluster(service) or from other services in the same application:
