...
p. Understanding Azure security credentials is necessary to successfully manage a Java application running on Azure.
...
p. 
Log in with your Windows Live credentials to the Azure Management Portal at [http://windows.azure.com] 
