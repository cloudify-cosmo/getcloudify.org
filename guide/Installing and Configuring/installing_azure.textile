...
<pre>cd <Cloudify Home>\tools\cli\plugins\azure
encutil -create -alias azure_rdp -pwd 123456 -pfx azure_rdp.pfx -cert azure_rdp.cer</pre>
...
<pre>encutil -encrypt -text MyPassword007 -cert azure_rdp.cer > password.txt
notepad password.txt</pre>
...
<pre>encutil -create -alias azure_api -pwd 123456 -pfx azure_api.pfx -cert azure_api.cer</pre>
# Save the certificate thumbprint, for later use.
<pre>encutil -thumbprint -cert azure_api.cer</pre>
