...
# Go to the @<cloudify installation folder>/bin@ folder, and then run @cloudify.bat@ (Windows) or @cloudify.sh@ (Linux) depending on the operating system running on your machine.
  <img src="/guide/2.1/images/setup/shell_start2.jpg" width="630" height="300" />
...
<img src="/guide/2.1/images/setup/shell_boot3.jpg" width="630" height="300" />
...
<img src="/guide/2.1/images/setup/pet_clinic_anatomy4_211ga.jpg" />
...
<img src="/guide/2.1/images/setup/petClinic_in_webui_screenShot4.jpg" width="630" height="300"/>
