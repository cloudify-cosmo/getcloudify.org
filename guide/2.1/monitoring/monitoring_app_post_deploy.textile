...
In addition to using the "web management console":/guide/monitoring/the_web_management_console, you can use the following Cloudify commands to monitor your applications:
