...
<img src="/guide/2.1/images/recipes/app_lifecycle.png"/>
...
<img src="/guide/2.1/images/recipes/srvc_lifecycle1.png"/>
...
<img src="/guide/2.1/images/recipes/service_instance_lifecycle.png"/>
...
Alternatively, if you do not want to monitor process at all, describe a process locator closure that returns an empty list of process ids. For example, this is useful when you have a service that frequenty spawns and kills processes, or when you do not want to monitor the liveness of your service.
...
<img src="/guide/2.1/images/recipes/context_injection.png"/>
