...
** "General":/guide/developing/service_recipe#general: The service name, service type, number of service instances, and the service icon filename
...
** "Custom commands":/guide/developing/custom_commands: Maps custom events to handling scripts that can be invoked as commands using the Cloudify shell
...
!/guide/2.1/images/recipes/recipe_ingrid.png!

The following diagram depicts the application's recipe folder structure.
!/guide/2.1/images/recipes/recipe_folder.png!