...
Cloudify recipes can use probes for monitoring service configuration, performance, and availability. The collated performance metrics can be "configured":/guide/developing/configuring_ui_section to display in the *Metrics* pane of the Cloudify web management console.
...
* "Using Scripted Probes":/guide/plugins_and_probes/probes
