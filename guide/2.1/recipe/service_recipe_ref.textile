...
var messages = {
    ...
    icon:'The image file to use as an icon for the service in the web management console, optional',
    ...
    value:'The threshold value above/below which the number of instances is scaled',
