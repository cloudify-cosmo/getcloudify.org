...
!/guide/2.1/images/ec2/EC2_CREATE_KEY_PAIRS_RAW3.jpg!
# Type a name for the key pair.
!/guide/2.1/images/ec2/EC2_CREATE_KEY_PAIRS_1_RAW3.jpg!
# Save the private key file (@myKeyPair-name.pem@ in our example) in the @<cloudifyRoot>/tools/cli/plugins/esc/ec2/upload@ folder.
!/guide/2.1/images/ec2/EC2_CREATE_KEY_PAIR_SUCCESS_AND_SAVE3.jpg!
...
!/guide/2.1/images/ec2/EC2_ACCESS_KEY_AND_SECRET_KEY3.jpg!
...
** *locationId* - Specify the zone type from EC2 (e.g. @us-east-1@, which corresponds to *US East, Virginia*).
    !/guide/2.1/images/ec2/ec2_images_types.jpg!
