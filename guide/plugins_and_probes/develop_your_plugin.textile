...
<code>setServiceContext</code> is being invoked first by the USM, injecting the instance of <code>ServiceContext</code>. Then, the USM invokes the <code>setConfig</code> injecting a <code>Map</code> of the configuration from the recipe.
