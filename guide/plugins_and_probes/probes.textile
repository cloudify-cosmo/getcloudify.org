...
h4(noteYellow). It is important to note that Cloudify will invoke the @restart@ event if you implemented one and the @start@ event will only serve as a fallback.
