...
As mentioned above, in our recipe we use: two shards (Mongod), one configuration server (MongoCfg), one routing server (MongoS) and one Tomcat.
Here's our Pet Clinic Application's Topology:

<img src="/guide/images/overview/petClinicSharding.jpg" />


h1. Mongo services in the Pet Clinic Recipe
