...
h2. Can you shard on a cloud in a galaxy far far away ? 

In general, managing a "sharded mongo":http://www.mongodb.org/display/DOCS/Sharding+Introduction setup is not an easy task but it's much more difficult to do it on a cloud.
When you deploy a sharded mongo on a cloud (any cloud...), you have quite a few barriers that you need to overcome :
* How will you make sure that the Mongo Routing Server finds the location of the shards ?
* Does this router know where the Mongo Config Server resides ? 
* How can you verify that your sharding actually works?
* Will you be able to monitor your application's perfomance?
* Can you scale out or in ? 

<br/>
Cloudify enables you to achieve all of the above and more.
So, in order to understand how we do it, I will give you a more thorough walk-through into the MongoDB recipe in the Pet Clinic Application recipe that we described in the "Quick Start Guide":/guide/qsg/quick_start_guide.
