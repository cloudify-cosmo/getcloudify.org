...
!GRA:Images2^EC2_CREATE_KEY_PAIRS_RAW3.jpg!

Step 2:

!GRA:Images2^EC2_CREATE_KEY_PAIRS_1_RAW3.jpg!

Step 3:

!GRA:Images2^EC2_CREATE_KEY_PAIR_SUCCESS_AND_SAVE3.jpg!
...
You can get an active Access Key ID from the [Access Credentials section in EC2 Console|https://aws-portal.amazon.com/gp/aws/developer/account/index.html?action=access-key|Link to the Access Credentials section in EC2 Console] as shown here:
!GRA:Images2^EC2_ACCESS_KEY_AND_SECRET_KEY3.jpg!
 ** *apiKey* - Insert your EC2 Secret Access Key.
You can get a Secret Access Key from the [Access Credentials section in EC2 Console|https://aws-portal.amazon.com/gp/aws/developer/account/index.html?action=access-key|Link to the Access Credentials section in EC2 Console] as shown above.
...
!GRA:Images2^EC2_Instance_Types3.jpg!
...
cloud {
	...
	provider {
	    ...
	    cloudifyUrl "REPLACE_WITH_FULL_URL_PATH_TO_gigaspaces-cloudify.zip"		
		  
	    machineNamePrefix "REPLACE_WITH_YOUR_DESIRED_INSTANCE_NAME_PREFIX"
	    ...
	    managementGroup "REPLACE_WITH_MANAGEMENT_MACHINES_PREFIX"
	...
	user {
            user "REPLACE_WITH_EC2_ACCESS_KEY_ID"
	    apiKey "REPLACE_WITH_EC2_SECRET_ACCESS_KEY"
	    keyFile "REPLACE_WITH_THE_PRIVATE_KEY_FILE_NAME_YOU_CREATED_ON_EC2"
	}
		
	templates ([
	    SMALL_LINUX_32 : template{
            locationId "REPLACE_WITH_ZONE_TYPE"					 
            imageId "REPLACE_WITH_ZONE_TYPE/REPLACE_WITH_AMAZON_MACHINE_ID"			  
            machineMemoryMB 1600	
            hardwareId "REPLACE_WITH_EC2_API_NAME_OF_DESIRED_HARDWARE_TYPE"				
	    options ([
                "securityGroups" : ["REPLACE_WITH_DESIRED_SECURITY_GROUP1", "REPLACE_WITH_DESIRED_SECURITY_GROUP2"] as String[],  
	        "keyPair" : "REPLACE_WITH_THE_KEY_PAIR_NAME_YOU_CREATED_ON_EC2" 
            ])
	   }
        ])			
}
