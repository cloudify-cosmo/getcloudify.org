...
* Learn more about cloud portability and "cloud drivers":/guide/developing_cloud_drivers/developing_custom_clouddriver].
* Learn how to "develop a monitoring plugin":/guide/plugins_and_probes/develop_your_plugin.
* Learn how to further monitor your application with the "Web Based UI":/guide/monitoring/the_web_management_console.textile.
