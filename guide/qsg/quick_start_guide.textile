...
(info)h4. The "Amazon Quick Start Guide":guide/qsg/quick_start_guide_ec2 shows how to deploy the same application on Amazon EC2, and contains a sharded MongoDB configuration with multiple mongod instances
