...
h4(info). The mongod uses the "extends mechanism":/guide/developing/extending_recipes and its actual code is in @<cloudify root>/recipes/services/mongodb/mongod@.
