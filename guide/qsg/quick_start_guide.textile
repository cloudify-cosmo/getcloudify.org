...
* Use an example recipe to deploy an application on a "localcloud(Bootstrapping)":/guide/Bootstrapping/bootstrapping_localcloud using Cloudify, starting from how to install Cloudify and ending in monitoring the deployed application.
...
*<pre>uninstall-application petclinic</pre>*
...
To turn off all localcloud services type the following command: *<pre>teardown-localcloud</pre>*
