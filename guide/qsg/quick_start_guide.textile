...
# The Data Tier - Composed of Mongod sharded instances (AKA shards): In our case, there are two instances of mongod to store the application data.
...
<h4 class="noteYellow">When you install MongoDB on Windows 7, you need to make sure that you run as an administrator. See "Installing MongoDB on Windows 7":http://www.mongodb.org/display/DOCS/Windows+Service.
</h4>
