...
Before deploying an application, you must configure the recipe that will be used for the deployment. In this example, we have already configured this for you; therefore, the recipe can be used as-is without any further configuration and you can proceed to the next step. However, we recommend you read the following to gain an understanding of the recipe, and then optionally configure the number of service instances used by the services defined in the recipe:
...
* <span class="expandBtn" title="/guide/developing/configuring_ui_sections">Configuring the Web Management Console</span>
