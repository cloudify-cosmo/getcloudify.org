...
Before you install the Cloudify shell, make sure that your environment meets all the minimum requirements. For more information, see <span class="expandBtn" title="/guide/setup/cloudify_prerequisites">Cloudify Prerequisites</span>.
...
For more information, see <span class="expandBtn" title="/guide/setup/installing_the_cloudify_client">Installing the Cloudify Shell</span>.
...
For a more information about how to configure the EC2 cloud driver, see <span class="expandBtn" title="/guide/setup/configuring_ec2">Configure EC2</span>.
...
For more information about Bootstrapping on EC2, see <span class="expandBtn" title="/guide/bootstrapping/bootstrapping_ec2">Boostrap EC2</span>.
...
For more information about recipes, click <span class="inlineExpandBtn">here</span>.
<div class="expand">
* <span class="expandBtn" title="/guide/developing/recipes_overview">Anatomy of a Recipe</span>
* <span class="expandBtn" title="/guide/developing/application_recipe">The Application Recipe</span>
* <span class="expandBtn" title="/guide/developing/service_recipe">The Service Recipe</span>
* <span class="expandBtn" title="/guide/developing/lifecycle_events">Lifecycle Events</span>
* <span class="expandBtn" title="/guide/developing/recipe_parameters">Recipe Parameterization</span>
* <span class="expandBtn" title="/guide/developing/extending_recipes">Extending Service Recipes</span>
* <span class="expandBtn" title="/guide/developing/the_service_context_api">The Service Context API</span>
* <span class="expandBtn" title="/guide/developing/attributes_api">The Attributes API</span>
...
* <span class="expandBtn" title="/guide/developing/sla_requirements">SLA Requirements</span>
* <span class="expandBtn" title="/guide/developing/scaling_rules">Scaling Rules</span>

<br />
The following is a list of the application recipe's files and folders, in our example located @<cloudify root>/recipes/apps/petclinic@, that are used to deploy the PetClinic application:
...
<img src="/guide/images/setup/pet_clinic_anatomy3_211m2.JPG" />
...
To monitor the application,  open a web browser, and then browse to the "Web Management Console":/guide/monitoring/the_web_management_console. Once the page is loaded, simply login anonymously without specifying a username or password.
...
For more information, see <span class="expandBtn" title="/guide/developing/scaling_rules">Scaling Rules</span>.
