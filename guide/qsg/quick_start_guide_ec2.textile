...
h4(info). You can specify any preferred name for lifecycle handlers, as long as you specify their exact names in the corresponding service file.
...
<p style="padding-left:1em;">*install-application* @-timeout 50 <cloudify root>/examples/petclinic@
<span style="padding-left:1em;">where @<Cloudify root>@ is the path to the Cloudify installation on your machine.</span></p>
