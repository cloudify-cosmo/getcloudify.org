...
h4(info). All the mongo* services use the "extends mechanism":/guide/developing/extending_recipes and their actual code is in @<cloudify root>/recipes/services/mongodb/*@.
