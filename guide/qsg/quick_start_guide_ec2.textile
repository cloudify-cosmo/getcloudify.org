...
<p style="padding-left:1em;">*install-application* @-timeout 50 <cloudify root>/examples/petclinic@</p>
<p style="padding-left:2em;">where @<Cloudify root>@ is the path to the Cloudify installation on your machine.</p>
