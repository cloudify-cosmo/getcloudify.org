...
The BYON Cloud Driver is an implementation of the Cloudify Cloud Driver allowing a user to use a set of physical machines or virtual machines
...
on available machine using the templates names specified in the service recipes.
