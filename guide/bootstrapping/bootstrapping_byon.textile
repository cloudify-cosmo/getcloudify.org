...
Once the SMALL_LINUX template is specified, to associate the template with a service you must specify it in the service file included with the recipe, as follows:
