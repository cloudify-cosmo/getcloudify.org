...
In this case, the application installation will not revert, just like it doesn't revert on other clouds. The Cloudify Controller will keep retrying to look for available machine to provision the service. You may stop the process by un-installing the application.
