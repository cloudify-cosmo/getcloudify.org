...
Each of the shapes on the application map represents a service (which is usually a cluster of service instances) of the deployed application. Looking closer at one of these we can notice the following:
