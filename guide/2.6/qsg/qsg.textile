...
Invoke the following command : *gigaspaces-cloudify-2.7/bin $ ./cloudify.sh*

* *Bootstrap the local cloud* 
This will install Cloudify management,agent and UI on your machine.
Invoke the following command : *cloudify@default>bootstrap-localcloud*
...
Invoke the following command: *cloudify@default>install-application helloworld*
...
To uninstall the application, invoke the following command: *cloudify@default>uninstall-application helloworld*

h2(#step5). Step 5 - Teardown the Local Cloud

To teardown the local cloud installation, invoke the following command: *cloudify@default>teardown-localcloud*
